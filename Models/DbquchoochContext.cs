...
public partial class DbquchoochContext : DbContext
{
    public DbquchoochContext()
    {
    }

    public DbquchoochContext(DbContextOptions<DbquchoochContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CodigoCiudad).HasName("pk_ciudad_codigoCiudad");

            entity.ToTable("ciudad");

            entity.Property(e => e.CodigoCiudad).HasColumnName("codigoCiudad");
            entity.Property(e => e.Nombre)
                .HasMaxLength(128)
                .IsUnicode(false)
                .HasColumnName("nombre");
