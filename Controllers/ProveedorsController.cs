...
namespace systemquchooch.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ProveedorsController(QuchoochContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string buscar, string ordenActual, int? numpag, string filtroActual)
        {
            ...
            switch (ordenActual)
            {
                case "NombreDescendente":
                    proveedors = proveedors.OrderByDescending(proveedor => proveedor.Nombre);
                    break;
                default:
                    proveedors = proveedors.OrderBy(proveedor => proveedor.Nombre);
                    break;
            }
        ...
        public async Task<IActionResult> Create([Bind("CodigoProveedor,Nombre,Descripcion")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CodigoProveedor,Nombre,Descripcion")] Proveedor proveedor)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'QuchoochContext.Proveedors'  is null.");
            }
            var proveedor = await _context.Proveedors.FindAsync(id);
            if (proveedor != null)
            {
